...
<div class="container mt-5">
    <p>
        <a class="btn btn-outline-success" href="create.php">Criar novo usuário</a>
    </p>
        ...
        <tbody>
            <?php foreach ($users as $user) : ?>
                <tr>
                    ...
                    <td>
                        <a href="view.php?id=<?php echo $user['id']; ?>" class="btn btn-sm btn-outline-info">Visualizar</a>
